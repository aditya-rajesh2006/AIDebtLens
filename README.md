...
AI Debt Lens is a React + Supabase application for analyzing AI-generated code risk, technical debt, and cognitive debt across GitHub repositories, uploaded files, and pasted code.

The current project combines deterministic heuristics, hybrid AI verification, cognitive modeling, interactive dashboards, and history/reporting features into a single analysis workflow.
...
- `cognitive-predict`
- `chatbot`
- `improved-cognitive-predict`
- `improved-train-cognitive-model`
- `model-validation`
